...
export const Hero = () => {
    return (
        <section className=' bg-gradient-to-tr py-4 from-[#E7F0FF] to-[#E8F1FF78] relative'>
            <div className=' container  h-[55%]  flex items-center'>
                <div className=' grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 '>
                    ...
                    <div className=' h-full lg:flex hidden items-center justify-end'>
                        <img 
            ...
            <div className='bg-[#fff] lg:block md:hidden sm:hidden hidden py-10 px-6 rounded-lg w-[78.5%] shadow-md m-auto absolute top-[33rem] left-1/2 transform -translate-x-1/2 -translate-y-1/2 '>
                <div className='lg:block md:hidden sm:hidden hidden'>
                    <SearchComp colsNum={3} />
                </div>
                <main className=' py-5 lg:block md:hidden sm:hidden hidden'>
